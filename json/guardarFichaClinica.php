...
//        . ""toma1BrazoIzquierdo":"asf","toma2BrazoDerecho":"asf","toma2BrazoIzquierdo":"asf"}"
  $sql = "INSERT INTO `laboratorio`.`fichaClinica` (`keyFC`, "
        . "`toma1BrazoDerecho`,"
        . " `toma1BrazoIzquierdo`, "
        . "`toma2BrazoDerecho`, "
        . "`toma2BrazoIzquierdo`, `matricula`, `id_escuela`,fecha)"
        . " VALUES (NULL, '$obj_d->toma1BrazoDerecho',"
        . " '$obj_d->toma1BrazoDerecho', "
        . " '$obj_d->toma2BrazoDerecho', "
        . " '$obj_d->toma2BrazoIzquierdo',"
        . " '$obj_d->matricula',"
